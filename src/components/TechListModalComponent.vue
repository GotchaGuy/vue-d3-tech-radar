<template>
  <section v-if="displayed" class="sidebar-modal-component p-6 fixed bg-mvp-gray-darker w-2/5">
    ...
    <h2 class="text-4xl font-bold"> My tech list </h2>
    ...
    <div class="tech-list pb-6">
        <div class="tech-item bg-mvp-gray-light my-2 p-3 cursor-pointer hover:bg-border-gray-700" style="border-radius: 15px">
          <h3 class="text-2xl font-bold pl-2 pb-2">zk-SNARKs</h3>
